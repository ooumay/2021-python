...
dict_spring = {'P': 16,'L': 12,'E': 5,'N': 14,'K': 11,'I': 9,'N': 14}
# я не знаю, как не писать словарь два раза. 
# Пробовал dict = dict_spring, но тогда преобразования над одним словарём применялись к обоим словарям, а мне такого не надо, помогите
